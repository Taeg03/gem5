...
# 6 Parameter CLI: issue_width, rob_size, l1d_mshrs, l1d_size, l1d_assoc, l2_size, [workload_mode]
...
l2_size = sys.argv[6]
workload_mode = sys.argv[7] if len(sys.argv) > 7 else "compute"
...
# 3. Parameterized L2 Cache
system.l2cache = Cache(
    size=l2_size,
    assoc=8, # Fixed at 8-way to keep space at 729 points
    tag_latency=10,
    data_latency=10,
    response_latency=10,
    mshrs=20,
